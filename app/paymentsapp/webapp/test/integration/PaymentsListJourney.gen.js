...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onThePaymentsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePaymentsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onThePaymentsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onThePaymentsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onThePaymentsListGenerated.onFilterBar().iExecuteSearch();
            Then.onThePaymentsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onThePaymentsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onThePaymentsObjectPageGenerated.iSeeThisPage();
        });
